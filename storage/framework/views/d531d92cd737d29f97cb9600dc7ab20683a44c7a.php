<div class="container-fluid peruser_tab_view chart_view" id="peruser_tab_view_chart" style="display: none">
  
  <h4 class="pt-pb">General App Stats</h4>
  <div class="card card-primary">
    <div class="card-body">
      <div class="row general-analytics-first-row">
        <div class="col-md-4"><span><?php echo e($enrolled_users); ?></span> <span> enrolled users</span></div>
        <div class="col-md-4"><span><?php echo e($licence_num); ?></span> <span> licenses</span></div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-body">
              <div><span><?php echo e(round($french_users_pro, 2)); ?>%</span> <span> use the App in French</span></div>
              <div><span><?php echo e(round($english_users_pro, 2)); ?>%</span> <span> use the App in English</span></div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-body">
              <div><span><?php echo e($cor_weekly); ?></span> <span> weekly checks submitted</span></div>
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6"><span><?php echo e($cor_video_views); ?></span> <span> videos viewed</span></div>
                <div class="col-md-6"><span><?php echo e($cor_video_comments); ?></span> <span> interactions</span></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="form-group">
    <div class="input-group">
      ...
      <input type="text" id="showUser_week_chart" class="form-control float-right reservation">
    </div>
  </div>
  <div class="card card-primary">
    <div class="card-body">
  ...
  <div class="form-group">
    <div class="input-group">
      ...
      <input type="text" id="showUser_month_chart" class="form-control float-right reservation">
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="input-group">
      ...
      <input type="text" id="showUser_coaching_chart" class="form-control float-right reservation">
    </div>
  </div>
  <div>
    <div class="card card-primary">
...
<?php /**PATH D:\ZZZZZZZZZ\vieva_project\resources\views/backend/superadmin/analytics/peruser_chart.blade.php ENDPATH**/ ?>