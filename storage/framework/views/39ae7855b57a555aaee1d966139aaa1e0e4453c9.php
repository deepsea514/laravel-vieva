...
<section class="content tab-pane fade" id="custom-content-below-client" role="tabpanel"
  ...
  <div id="perclient_tab_view_table">
    <div class="container-fluid" id="perclient_tab_view_table">
      ...
      <div class="form-group">
        ...
        <select class="form-control select2" id="corporate_sel" style="width: 100%;">
          <?php $__currentLoopData = $corporate_clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $corporate_client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($corporate_client->corporate_client_id); ?>"><?php echo e($corporate_client->corporate_name); ?>
            ...
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo e($licence_num); ?></td>
                </tr>
                <tr>
                  <td>Enrolled users</td>
                  <td><?php echo e($enrolled_users); ?></td>
                </tr>
                <tr>
                  <td>Online users</td>
                  <td><?php echo e($cor_online_users); ?></td>
                </tr>
                <tr>
                  <td>French language</td>
                  <td><?php echo e(round($cor_fr_users_pro, 2)); ?>%</td>
                </tr>
                <tr>
                  <td>English language</td>
                  <td><?php echo e(round($cor_en_users_pro, 2)); ?>%</td>
                </tr>
                <tr>
                  <td>Accounts created on mobile</td>
                  <td><?php echo e(round($cor_mobile_pro, 2)); ?>%</td>
                </tr>
                <tr>
                  <td>Accounts created on the web</td>
                  <td><?php echo e(round($cor_web_pro, 2)); ?>%</td>
                </tr>
                <tr>
                  <td>Weekly checks submitted</td>
                  <td><?php echo e($cor_weekly); ?></td>
                </tr>
                <tr>
            ...
            <table id="engageClient" class="table table-bordered">
              <tbody>
                <tr>
                  ...
                  <td><?php echo e($cor_video_views); ?></td>
                </tr>
                <tr>
                  <td>Video likes</td>
                  <td><?php echo e($cor_video_likes); ?></td>
                </tr>
                <tr>
                  <td>Video comments</td>
                  <td><?php echo e($cor_video_comments); ?></td>
                </tr>
                <tr>
                  <td>Challenges accepted</td>
                  <td><?php echo e($cor_video_challenges); ?></td>
                </tr>
                <tr>
                  <td>Quote likes</td>
                  <td><?php echo e($cor_quotes); ?></td>
                </tr>
              </tbody>
            </table>
          </div>
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td><?php echo e($cor_coaching_session); ?></td>
                  </tr>
                  <tr>
                    <td>Average coach rating</td>
                    <td>

                      <?php echo e($cor_ave_coaching->average('rating')); ?> stars
              ...
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td><?php echo e(round($cor_depression)); ?>%</td>
                  </tr>
                  <tr>
                    <td>Parenting issues</td>
                    <td><?php echo e(round($cor_parenting)); ?>%</td>
                  </tr>
                  <tr>
                    <td>Relationship issues</td>
                    <td><?php echo e(round($cor_relationship)); ?>%</td>
                  </tr>
                  <tr>
                    <td>Mourning</td>
                    <td><?php echo e(round($cor_mourning)); ?>%</td>
                  </tr>
                  <tr>
                    <td>Conflictss</td>
                    <td><?php echo e(round($cor_conflicts)); ?>%</td>
                  </tr>
                  <tr>
                    <td>Self-confidence</td>
                    <td><?php echo e(round($cor_confidence)); ?>%</td>
                  </tr>
                  <tr>
                    <td>Addictions</td>
                    <td><?php echo e(round($cor_addictions)); ?>%</td>
                  </tr>
                  <tr>
                    <td>Others</td>
                    <td><?php echo e(round($cor_others)); ?>%</td>
                  </tr>
                </tbody>
              </table>
            </div>
    ...
    <?php echo $__env->make('backend.superadmin.analytics.perclient_chart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  </div>

</section>
<?php /**PATH D:\ZZZZZZZZZ\vieva_project\resources\views/backend/superadmin/analytics/perclient.blade.php ENDPATH**/ ?>