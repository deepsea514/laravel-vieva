<section class="content tab-pane fade show active" id="custom-content-below-general" role="tabpanel"
        ...
        <table class="table table-bordered">
          <tbody>
            <tr>
              ...
              <td><?php echo e($registered_users); ?></td>
            </tr>
            <tr>
              <td>Online users</td>
              <td><?php echo e($online_users); ?></td>
            </tr>
            <tr>
              <td>Free accounts</td>
              <td><?php echo e($free_accounts); ?></td>
            </tr>
            <tr>
              <td>Premium accounts</td>
              <td><?php echo e($premium_accounts); ?></td>
            </tr>
            <tr>
              <td>Corporate accounts</td>
              <td><?php echo e($corporate_accounts); ?></td>
            </tr>
            <tr>
              <td>French language</td>
              <td><?php echo e(round($french_users_pro)); ?>%</td>
            </tr>
            <tr>
              <td>English language</td>
              <td><?php echo e(round($english_users_pro)); ?>%</td>
            </tr>
            <tr>
              <td>Accounts created on mobile</td>
              <td><?php echo e(round($mobile_pro)); ?>%</td>
            </tr>
            <tr>
              <td>Accounts created on the web</td>
              <td><?php echo e(round($desktop_pro)); ?>%</td>
            </tr>
            <tr>
              <td>Weekly checks submitted</td>
              <td><?php echo e($week_checks); ?></td>
            </tr>
            <tr>
              <td>Monthly checks submitted</td>
              <td><?php echo e($month_checks); ?></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="table table-bordered">
          <tbody>
            <tr>
              ...
              <td><?php echo e($video_views); ?></td>
            </tr>
            <tr>
              <td>Video likes</td>
              <td><?php echo e($video_likes); ?></td>
            </tr>
            <tr>
              <td>Video comments</td>
              <td><?php echo e($video_comments); ?></td>
            </tr>
            <tr>
              <td>Challenges accepted</td>
              <td><?php echo e($challenges_accepted); ?></td>
            </tr>
            <tr>
              <td>Quote likes</td>
              <td><?php echo e($quotes); ?></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table id="weekGeneral" class="table table-bordered">
          <tbody>
            <tr>
              ...
              <td>
                <?php echo e((round($week_progress->average('workload_level'), 2) + round($week_progress->average('stress_level'), 2) + round($week_progress->average('energy_level'), 2)) / 3); ?>/5
              </td>
            </tr>
            <tr>
              <td>Workload average</td>
              <td><?php echo e(round($week_progress->average('workload_level'), 2)); ?>/5</td>
            </tr>
            <tr>
              <td>Stress average</td>
              <td><?php echo e(round($week_progress->average('stress_level'), 2)); ?>/5</td>
            </tr>
            <tr>
              <td>Energy average</td>
              <td><?php echo e(round($week_progress->average('energy_level'), 2)); ?>/5</td>
            </tr>
          </tbody>
        </table>
      </div>
          ...
          <table class="table table-bordered">
            <tbody>
              <tr>
                ...
                <td><?php echo e(round($all_checks->average('percent'), 2)); ?>%
                </td>
              </tr>
              <tr>
                <td>Average mood</td>
                <td><?php echo e((round($all_checks->average('QA1'), 2) + round($all_checks->average('QA2'), 2)) * 10); ?>%
                </td>
              </tr>
              <tr>
                <td>Average energy</td>
                <td><?php echo e((round($all_checks->average('QA3'), 2) + round($all_checks->average('QA4'), 2)) * 10); ?>%
                </td>
              </tr>
              <tr>
                <td>Average engagement</td>
                <td><?php echo e(round($all_checks->average('QA5'), 2) * 20); ?>%
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table class="table table-bordered">
            <tbody>
              <tr>
                ...
                <td><?php echo e($coaching_sessions); ?></td>
              </tr>
              <tr>
                <td>Average coach rating</td>
                <td><?php echo e(round($average_coaching_rates->average('rating'))); ?> stars</td>
              </tr>
              <tr>
          ...
          <table class="table table-bordered">
            <tbody>
              <tr>
                ...
                <td><?php echo e(round($depression)); ?>%</td>
              </tr>
              <tr>
                <td>Parenting issues</td>
                <td><?php echo e(round($parenting_issues)); ?>%</td>
              </tr>
              <tr>
                <td>Relationship issues</td>
                <td><?php echo e(round($relationship_issues)); ?>%</td>
              </tr>
              <tr>
                <td>Mourning</td>
                <td><?php echo e(round($mourning)); ?>%</td>
              </tr>
              <tr>
                <td>Conflictss</td>
                <td><?php echo e(round($conflicts)); ?>%</td>
              </tr>
              <tr>
                <td>Self-confidence</td>
                <td><?php echo e(round($self_confidence)); ?>%</td>
              </tr>
              <tr>
                <td>Addictions</td>
                <td><?php echo e(round($addictions)); ?>%</td>
              </tr>
              <tr>
                <td>Others</td>
                <td><?php echo e(round($others)); ?>%</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  <?php echo $__env->make('backend.superadmin.analytics.general_chart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


</section>
<?php /**PATH D:\ZZZZZZZZZ\vieva_project\resources\views/backend/superadmin/analytics/general.blade.php ENDPATH**/ ?>