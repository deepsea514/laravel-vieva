<div class="container-fluid general_tab_view chart_view" id="general_tab_view_chart" style="display: none">
  <button class="btn btn-info btn-generate-pdf" onclick="generatePDF(this, 'general_tab_view_chart')">Generate
    PDF</button>
  <h4 class="pt-pb">General App Stats</h4>
  <div class="card card-primary">
    <div class="card-body">
      <div class="row general-analytics-first-row">
        <div class="col-md-4"><span><?php echo e($general_enrolled_users); ?></span> <span> enrolled users</span></div>
        <div class="col-md-4"><span><?php echo e($general_licence_num); ?></span> <span> licenses</span></div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-body">
              <div><span><?php echo e(round($french_users_pro)); ?>%</span> <span> use the App in French</span></div>
              <div><span><?php echo e(round($english_users_pro)); ?>%</span> <span> use the App in English</span></div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-body">
              <div><span><?php echo e($week_checks); ?></span> <span> weekly checks submitted</span></div>
              <div><span><?php echo e($month_checks); ?></span> <span> montly checks submitted</span></div>
            </div>
          </div>
        </div>
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6"><span><?php echo e($video_views); ?></span> <span> videos viewed</span></div>
                <div class="col-md-6"><span><?php echo e($video_comments); ?></span> <span> interactions</span></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="form-group">
    <div class="input-group">
      ...
      <input type="text" id="showGeneral_week_chart" class="form-control float-right reservation">
    </div>
  </div>
  <div class="card card-primary">
    <div class="card-body">
  ...
  <div class="form-group">
    <div class="input-group">
      ...
      <input type="text" id="showGeneral_month_chart" class="form-control float-right reservation">
    </div>
  </div>
  <div id="monthGeneralChart">
    <div class="card card-primary">
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
  ...
  <div class="form-group">
    <div class="input-group">
      ...
      <input type="text" id="showGeneral_coaching_chart" class="form-control float-right reservation">
    </div>
  </div>
  <div>
    <div class="card card-primary">
...
<?php /**PATH D:\ZZZZZZZZZ\vieva_project\resources\views/backend/superadmin/analytics/general_chart.blade.php ENDPATH**/ ?>