...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <?php echo $__env->make("backend.layout.sidebar_coaching", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('js/coaching.js')); ?>"></script>
    ...
    <script>
        $(function () {
            ...
            // <?php $__currentLoopData = $first_coaching_reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            // $('#reservationdate<?php echo e($row->report_id); ?>').datetimepicker({
            //     format: 'L'
            // });
            // $('#reservationdate<?php echo e($row->report_id); ?>').datetimepicker({
            //     format: 'L'
...
<?php /**PATH D:\ZZZZZZZZZ\vieva_project\resources\views/backend/layout_coaching.blade.php ENDPATH**/ ?>